        ...
        <section className="welcome">
          <div className="container">
            ...
            <div className="welcome-actions">
              ...
              <Link href="/capsulas" className="btn btn-video" aria-label="Abrir cápsulas educativas">
                🎬 Acceso a videos
              </Link>
            </div>
          </div>
            ...
            <ul className="accesos-grid" role="list">
              {ACCESOS.map((a) => (
                <li key={a.slug} className="acceso-card-wrap">
                  <Link
                    href={a.href}
                    className={`acceso-card acceso-${a.slug === 'capsulas-educativas' ? 'activo' : ''}`}
                    aria-label={`${a.titulo}. ${a.descripcion}`}
                  >
                    <img className="acceso-imagen" src={a.imagen} alt="" />
                    <div className="acceso-texto">
                      <h3>{a.titulo}</h3>
                      <p>{a.descripcion}</p>
                    </div>
                    <span className="acceso-boton" aria-hidden="true">Abrir</span>
                  </Link>
                </li>
              ))}
            </ul>
