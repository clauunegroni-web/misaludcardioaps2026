...
export const CAPSULAS = [
  {
    slug: 'insulina', titulo: 'Insulina', tema: 'Diabetes', color: 'azul',
    resumen: 'Qué es la insulina, tipos, uso, sitios y señales de alerta.',
    tipo: 'video', duracionTexto: '1:10 min', imagen: '/imagenes/insulina-aplicacion.jpg',
    video: 'https://kv196ctez5usceel.public.blob.vercel-storage.com/c%C3%A1psula-insulina-v1.mp4',
    audioTexto: 'Aprende sobre el uso seguro de la insulina.', pasos: [], aviso: 'Consulta siempre a tu equipo de salud.'
  },
  {
    slug: 'presion-arterial', titulo: 'Presión arterial', tema: 'Presión arterial', color: 'verde',
    resumen: 'Cómo tomarte la presión en casa: postura, brazo y registro.',
    tipo: 'video', duracionTexto: '0:38 min', imagen: '/imagenes/presion-postura.jpg',
    video: 'https://kv196ctez5usceel.public.blob.vercel-storage.com/capsula-presion-arterial-v1.mp4',
    audioTexto: 'Aprende a tomarte la presión arterial en casa.', pasos: [], aviso: 'Si tienes síntomas de alarma, busca atención de urgencia.'
  },
  {
    slug: 'senales-de-alerta', titulo: 'Señales de alerta', tema: 'Emergencias', color: 'rojo',
    resumen: 'Cuándo pedir ayuda urgente.', tipo: 'video', duracionTexto: '1:15 min',
    ...
    audioTexto: 'Conoce las señales de alerta cardiovascular.', pasos: [], aviso: 'Ante dolor de pecho o dificultad para respirar, llama a emergencias.'
  }
]
